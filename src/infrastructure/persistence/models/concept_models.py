...
class ConceptCandidateModel(Base):
    """SQLAlchemy model representing a dynamically discovered concept candidate."""
    ...
    ontology_parent_candidate: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
