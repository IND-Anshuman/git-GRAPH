...
class Container:
    def __init__(self, config: Settings):
        ...
        self.architecture_pattern_registry = ArchitecturePatternRegistry("data/architecture_patterns")
        self.architecture_reasoning_engine = ArchitectureReasoningEngine(self.architecture_pattern_registry)
